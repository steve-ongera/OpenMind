...
# You can add custom views here for reports, dashboards, etc.
# Example:
# from django.urls import path
# from django.shortcuts import render
#
# def crisis_dashboard(request):
#     context = {
#         'alerts': CrisisAlert.objects.filter(status='detected').order_by('-detected_at')[:10],
#         'stats': DashboardStats.get_crisis_alerts_summary()
#     }
#     return render(request, 'admin/crisis_dashboard.html', context)
#
# # Add to admin.py:
# admin.site.get_urls = lambda: [
#     path('crisis-dashboard/', crisis_dashboard, name='crisis-dashboard'),
# ] + admin.site.get_urls()
...
#         }
#         js = ('admin/js/custom_admin.js',)created_at',)
